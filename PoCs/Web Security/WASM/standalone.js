...
function integrateWasmJS(Module) {
  ...
  var wasmTextFile = Module['wasmTextFile'] || 'standalone.wast';
  var wasmBinaryFile = Module['wasmBinaryFile'] || 'standalone.wasm';
  var asmjsCodeFile = Module['asmjsCodeFile'] || 'standalone.temp.asm.js';
...
memoryInitializer = Module["wasmJSMethod"].indexOf("asmjs") >= 0 || Module["wasmJSMethod"].indexOf("interpret-asm2wasm") >= 0 ? "standalone.html.mem" : null;
