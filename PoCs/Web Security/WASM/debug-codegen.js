...
function integrateWasmJS(Module) {
  ...
  var wasmTextFile = Module['wasmTextFile'] || 'debug-codegen.wast';
  var wasmBinaryFile = Module['wasmBinaryFile'] || 'debug-codegen.wasm';
  var asmjsCodeFile = Module['asmjsCodeFile'] || 'debug-codegen.temp.asm.js';
...
memoryInitializer = Module["wasmJSMethod"].indexOf("asmjs") >= 0 || Module["wasmJSMethod"].indexOf("interpret-asm2wasm") >= 0 ? "debug-codegen.html.mem" : null;
